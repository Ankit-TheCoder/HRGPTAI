...
const features = [
  {
    ...
    description: 'Automatically shortlist top candidates based on skills, experience, and job fit.',
    icon: '📄',
  },
  {
    title: 'AI Chatbot Interviews',
    description: 'Conduct interactive pre-screening interviews to save time and identify the best fits.',
    icon: '💬',
  },
  {
    title: 'Psychoanalytical Testing',
    description: 'Evaluate candidates\' personalities, work styles, and cultural fit within your organization.',
    icon: '🧠',
  },
];
...
const testimonials = [
  {
    ...
    image: "https://placehold.co/100x100/EEE/31343C?text=JL&font=montserrat"
  },
  {
    id: 2,
    ...
    name: "Marcus Johnson",
    position: "Chief People Officer, Global HR Solutions",
    image: "https://placehold.co/100x100/EEE/31343C?text=MJ&font=montserrat"
  },
  {
    id: 3,
    ...
    position: "Director of Operations, QuickHire Staffing",
    image: "https://placehold.co/100x100/EEE/31343C?text=SR&font=montserrat"
  }
];

const integrationPartners = [
  { name: "Workday", logo: "https://placehold.co/200x80/EEE/31343C?text=Workday&font=montserrat" },
  { name: "SAP SuccessFactors", logo: "https://placehold.co/200x80/EEE/31343C?text=SAP&font=montserrat" },
  { name: "Oracle HCM", logo: "https://placehold.co/200x80/EEE/31343C?text=Oracle&font=montserrat" },
  { name: "BambooHR", logo: "https://placehold.co/200x80/EEE/31343C?text=BambooHR&font=montserrat" },
  { name: "Greenhouse", logo: "https://placehold.co/200x80/EEE/31343C?text=Greenhouse&font=montserrat" },
  { name: "Lever", logo: "https://placehold.co/200x80/EEE/31343C?text=Lever&font=montserrat" }
];
